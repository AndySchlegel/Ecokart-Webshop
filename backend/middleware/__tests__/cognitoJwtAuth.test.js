...
const cognitoJwtAuth_1 = require("../cognitoJwtAuth");
...
describe('Middleware - verifyJwtToken', () => {
    beforeEach(() => {
        ...
        aws_jwt_verify_1.CognitoJwtVerifier.create.mockReturnValue(mockJwtVerifier);
    ...
    it('should verify valid token and set req.user', async () => {
        ...
        // ACT
        await (0, cognitoJwtAuth_1.verifyJwtToken)(req, res, next);
        // ASSERT
...
describe('Middleware - requireAuth', () => {
    ...
    it('should allow access if user is authenticated', async () => {
        ...
        mockVerify.mockResolvedValue(mockTokenPayload);
        // ACT
        await (0, cognitoJwtAuth_1.requireAuth)(req, res, next);
        // ASSERT
...
describe('Middleware - requireAdmin', () => {
    ...
    it('should allow access if user is admin', async () => {
        ...
        // ACT
        await (0, cognitoJwtAuth_1.requireAdmin)(req, res, next);
        // ASSERT
        expect(req.user).toBeDefined();
